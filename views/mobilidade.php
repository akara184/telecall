...
<head>
    ...
    <link rel=" stylesheet" href="/telecall/assets/css/mobilidade.css" />
...
<body>
    ...
    <section class="hero is-fullheight">
        <img src="/telecall/assets/img/mobilidadeMenu.png" alt="">
    </section>

    <section class="section is-large">
        <h1 class="title is-2 blue">Serviços de Mobilidade</h1>
        <div class="columns mt-5 is-8 is-variable is-centered">
            <div class="column is-4-tablet is-3-desktop">
                <div class="card">
                    <div class="card-content">
                        <div class="card-image has-text-centered px-4">
                            <img src="/telecall/assets/img/smartphone.png" alt="">
                            <p class="title is-4 blue"> Celular Empresarial </p>
                        </div>
                        <hr>
                        <p class="subtitle is-size-6 blue">
                        Monte <span class="red">planos de celular personalizados</span> para a sua <span
                            class="red">empresa</span>.</p>
                    </div>
                    <footer class="card-footer">
                        <p class="card-footer-item">
                            <a href="/telecall/mobilidade/celularEmp">
            ...
            <div class="column is-4-tablet is-3-desktop">
                <div class="card disabled">
                    <div class="card-content">
                        <div class="card-image has-text-centered px-4">
                            <img src="/telecall/assets/img/sim-de-telefone.png" alt="">
                            <p class="title is-4 blue"> MVNA/E </p>
                        </div>
                        <hr>
                        <p class="subtitle is-size-6 blue">
                            Sua <span class="red">empresa</span> operando no mercado móvel com a <span class="red">melhor cobertura</span> do Brasil.
                        </p>
                    </div>

                    <footer class="card-footer">
                        <p class="card-footer-item">
                            <a href="/telecall/bandaLarga"> <button class="button aProduct">Saiba
                                    mais</button></a>
                        </p>
                    </footer>
                </div>
