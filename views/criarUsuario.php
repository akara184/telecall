...
<head>
    ...
    <link rel="stylesheet" href="/telecall/assets/css/inserir.css">
...
<body>
    ...
    <form action="/telecall/models/cadastroCrud.php" method="POST">
        <section class="hero is-fullheight ">
            <div class="hero-body is-justify-content-center">
                <div class="columns is-flex is-flex-direction-column box">
                    <p class="title is-1">Novo Registro de <span class="corVermelho"> Usuário</span></p>
                    <p class="subtitle is-5" id="pCinza">Registre um novo usuário no banco de dados.</p>
