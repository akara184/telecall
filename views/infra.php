...
<head>
    ...
    <link rel="stylesheet" href="/telecall/assets/css/infra.css" />
    <link rel="stylesheet" href="/telecall/assets/vendors/fontawesome/css/all.css" />
    <link rel="stylesheet" href="/telecall/assets/frameworks/swiper/swiper/swiper-element-bundle.css">
    ...
    <script src="/telecall/assets/frameworks/swiper/swiper/swiper-element-bundle.min.js"></script>
...
<body>
    ...
    <section class="hero is-fullheight">
        <img src="/telecall/assets/img/banner-infra.png" alt="">
    </section>
    
    <div class="columns is-multiline" data-aos="fade-right" data-aos-easing="linear">
    <section class="section is-large">
        <h1 class="title is-2 blue"> Transformação Digital para seu negócio</h1>
        <div class="columns mt-5 is-8 is-variable is-centered">
            <div class="column is-4-tablet is-3-desktop">
                    <div class="card">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="/telecall/assets/img/infra.png" alt="">
                                <p class="title is-4 blue">pontoAPonto</p>
                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue"> <span class="red">Acesso dedicado </span> para <span
                                    class="red">ligação</span> entre <span class="red"> dois pontos</span>.
                        </div>
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="/telecall/infra/pontoAPonto">
                ...
                <div class="column is-4-tablet is-3-desktop">
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="/telecall/assets/img/computacao-em-nuvem.png" alt="">
                                <p class="title is-4 blue">MPLS</p>
                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue">
                                Formação de <span class="red">rede</span> com protocolo <span class="red">MPLS</span>.
                            </p>
                        </div>

                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="banda-larga/banda-larga"> <button class="button aProduct">Saiba
                                        mais</button></a>
                            </p>
                        </footer>
                    </div>
                ...
                <div class="column is-4-tablet is-3-desktop">
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="/telecall/assets/img/fibra-otica.png" alt="">
                                <p class="title is-4 blue">Fibra Apagada e Dutos</p>

                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue">
                                Locação <span class="red">privada</span> de <span class="red">fibra apagada</span> e
                                <span class="red">dutos</span>.
                            </p>
                        </div>
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="wi-fi/wi-fi"> <button class="button aProduct">Saiba mais</button></a>
                            </p>
                        </footer>
                    </div>
                </div>
                <div class="column is-4-tablet is-3-desktop">
                    <div class="card disabled">
                        <div class="card-content">
                            <div class="card-image has-text-centered px-4">
                                <img src="/telecall/assets/img/serv.png" alt="">
                                <p class="title is-4 blue">Co-location</p>

                            </div>
                            <hr>
                            <p class="subtitle is-size-6 blue">
                                Locação de <span class="red">espaço em rack</span> no Data Center da <span
                                    class="red">Telecall</span>. </p>
                        </div>
                        <footer class="card-footer">
                            <p class="card-footer-item">
                                <a href="wi-fi/wi-fi"> <button class="button aProduct">Saiba mais</button></a>
        ...
        <div class="container">
            <div class="columns is-multiline is-centered">
                <div class="column is-4-fullhd is-3-widescreen is-4-desktop is-6-tablet is-12-mobile mb-6">
                    <a href="/telecall/main/home" class="logo is-flex is-centered">
