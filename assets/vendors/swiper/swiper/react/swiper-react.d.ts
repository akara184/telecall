...
interface SwiperProps
  extends Omit<
    React.phpAttributes<HTMLElement>,
    | 'onProgress'
    | 'onClick'
    | 'onTouchEnd'
    | 'onTouchMove'
    ...
    | 'onResize'
  > {}
interface SwiperSlideProps extends Omit<React.phpAttributes<HTMLElement>, 'children'> {}

interface SwiperRef extends React.phpAttributes<HTMLElement> {
  swiper: SwiperClass;
}
